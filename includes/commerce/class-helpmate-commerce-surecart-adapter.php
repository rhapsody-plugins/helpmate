...
class Helpmate_Commerce_SureCart_Adapter implements CommerceProviderAdapter
{
	private $helpmate;
	...
	{
		return $this->helpmate->get_surecart()->get_products_by_keywords($keywords, $limit);
	}

	public function get_product(int $product_id): ?array
	{
		$product = $this->helpmate->get_surecart()->get_product_info($product_id);
