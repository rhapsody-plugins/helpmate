...
import { TestChatWithLauncher } from './components/TestChatWithLauncher';
    ...
    <PageGuard page="test-chatbot">
      <div className="gap-0">
        ...
        <div className="flex gap-6 p-6">
          ...
          {/* Right Column - Test Chatbot (same layout as customization preview) */}
          <div className="flex flex-col items-end justify-end w-3/5">
            <TestChatWithLauncher />
          </div>
